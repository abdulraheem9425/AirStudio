    ...
    <div className="bg-gray-50 py-12 px-2 md:px-6 lg:px-20 py-5">
      <div>
        <div className="flex justify-between items-center mb-8 flex-wrap gap-4">
          <div>
            <h2 className="text-2xl md:text-3xl font-bold tracking-widest text-orange-400">
              Featured Products
            </h2>
            <p className="text-gray-600 text-lg  tracking-wider">Discover our latest collection</p>
          </div>
          ...
          {products.map((product, index) => (
            ...
            >
              ...
              <div className="flex justify-between items-center px-4">
                <p className="text-blue-700 text-xl font-semibold mb-5">
                  ${product.price}
                </p>
                <Link to="/detail-card">
                  <button className="bg-orange-400 text-white text-sm px-4 py-1 mb-5 rounded-full">
                    Add to Cart
                  </button>
                </Link>
              </div>
