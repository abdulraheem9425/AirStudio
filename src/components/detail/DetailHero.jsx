...
const DetailHero = () => {
  ...
  <img src="/assets/images/detail2.png" className="w-32 h-20 lg:w-40 lg:h-22 rounded-lg hover:border-2 snap-center" alt="Thumbnail 2" />
  <img src="/assets/images/detail3.png" className="w-32 h-20 lg:w-40 lg:h-22 rounded-lg hover:border-2 snap-center" alt="Thumbnail 3" />
  <img src="/assets/images/detail4.png" className="w-32 h-20 lg:w-40 lg:h-22 rounded-lg hover:border-2 snap-center" alt="Thumbnail 4" />
  <img src="/assets/images/detail5.png" className="w-32 h-20 lg:w-40 lg:h-22 rounded-lg hover:border-2 snap-center" alt="Thumbnail 5" />
  <img src="/assets/images/detail6.png" className="w-32 h-20 lg:w-40 lg:h-22 rounded-lg hover:border-2 snap-center" alt="Thumbnail 6" />
</div>
      ...
      <div className="lg:col-span-7 flex flex-col gap-4">
        ...
        <div className="flex flex-wrap items-center gap-3">
          <button className="border px-4 py-1 text-sm rounded">Best Seller</button>
          <span className="flex items-center text-sm text-gray-600">
            <img src="/assets/images/current.png" alt="Cart" className="w-4 h-4 mr-2" />
  ...
  <button className="w-10 h-10 border border-gray-300 rounded hover:bg-black hover:text-white">XL</button>
        ...
        <div className="flex flex-wrap gap-10 text-sm underline mt-2">
          ...
          <span className="cursor-pointer flex items-center">
            <img src="/assets/images/question.png" alt="" className="h-4 mr-2" />
            Ask a question
          </span>
          <span className="cursor-pointer flex items-center">
        ...
        <div className="flex flex-col gap-3 mt-4">
          <div className="flex items-center gap-3">
            <svg xmlns="http://www.w3.org/2000/svg" className="text-black" width="24" height="24" fill="none" stroke="currentColor" strokeWidth="2">
              <path d="M20 13c0 5-3.5 7.5-7.66 8.95a1 1 0 0 1-.67-.01C7.5 20.5 4 18 4 13V6a1 1 0 0 1 1-1c2 0 4.5-1.2 6.24-2.72a1.17 1.17 0 0 1 1.52 0C14.51 3.81 17 5 19 5a1 1 0 0 1 1 1z" />
              <path d="m9 12 2 2 4-4" />
            </svg>
            <span className="text-sm font-semibold">Guarantee Safe<br /> Checkout</span>
          </div>
          <div className="flex items-center gap-3 flex-wrap lg:ml-10 mt-2">
  <img src="/assets/images/visa.png" alt="Visa" className="h-6 lg:relative left-30 bottom-14" />
  <img src="/assets/images/pay.png" alt="Pay" className="h-6 lg:relative left-30 bottom-14" />
  <img src="/assets/images/jazz.png" alt="Jazz" className="h-6 lg:relative left-30 bottom-14" />
  <img src="/assets/images/amex.png" alt="Amex" className="h-6 lg:relative left-30 bottom-14" />
  <img src="/assets/images/pp.png" alt="PayPal" className="h-6 lg:relative left-30 bottom-14" />
</div>
